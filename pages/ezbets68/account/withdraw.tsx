...
const withdraw = () => {
  ...
  const columns = ['username', 'coin', 'address', 'total', 'receive', 'status', 'comfirm', 'message', 'action']
  const data = []
      ...
      <div className='mb-3 pb-5'>
        ...
        <Row className={`mx-0 my-2 ${styles.player_report_row_background}`}>
          <div className={`${styles.player_report_table_mainHeading} text-center p-2`}>
            <label className={`${styles.font18} text-light ${styles.fw700}`}>Withdraw List Infromation</label>
          </div>
